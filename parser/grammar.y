...
ast::EExpression *bisonParseResult = nullptr;
...
expression: INTEGER { $$ = new ast::EExpression(ast::Integer{$1}); }
          | '(' expression ')' { $$ = $2; }
          | '-' expression {
    $$ = new ast::EExpression(ast::Prefix('-', *$2));
    delete $2;
}
          | expression '+' expression {
    $$ = new ast::EExpression(ast::Infix(*$1, '+', *$3));
    delete $1;
    delete $3;
}
          | expression '-' expression {
